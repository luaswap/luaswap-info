...
import { FEE_WARNING_TOKENS, FEE_SWAP } from '../constants'
      ...
      <ContentWrapper>
        <RowBetween>
          <TYPE.body>
            ...
            <Link lineHeight={'145.23%'} href={'https://scan.tomochain.com/address/' + account} target="_blank">
              {' '}
              {account?.slice(0, 42)}{' '}
            </Link>
          </TYPE.body>
        ...
        <Header>
          <RowBetween>
            <span>
              ...
              <Link lineHeight={'145.23%'} href={'https://scan.tomochain.com/address/' + account} target="_blank">
                <TYPE.main fontSize={14}>View on Tomoscan</TYPE.main>
              </Link>
            </span>
            <AccountWrapper>
              <StyledIcon>
            ...
            <AutoRow gap="20px">
              ...
              <AutoColumn gap="8px">
                <TYPE.header fontSize={24}>
                  {totalSwappedUSD ? formattedNum(totalSwappedUSD * FEE_SWAP, true) : '-'}
                </TYPE.header>
